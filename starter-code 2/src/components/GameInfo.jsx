  ...
  return (
    <>
      ...
      <div className="aboutPage">
        ...
        <br /> Nominations: BAFTA Games Award for EE Mobile Game of the Year,
        BAFTA Games Award for Mobile
        <br /> Game Genres: Multiplayer online battle arena, Action role-playing
        game
